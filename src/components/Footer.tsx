        ...
        <div className="footer__grid">
          <div className="footer__about">
            ...
            <p className="footer__desc">
              Habitant augue molestie felis purus platea mollis mauris lectus cursus.
              Viverra scelerisque commodo sem nisl sed vitae in neque volutpat.
            </p>
            <div className="footer__contact">
              ...
              <div className="footer__contact-item">
                <span className="footer__icon">📞</span>
                <span>Cuộc gọi khẩn cấp<br />(+86) 1208 1091 86</span>
              </div>
            </div>
          </div>
          ...
          <div className="footer__links">
            ...
            <ul className="footer__list">
              <li><a href="#primary">Chăm sóc sơ cấp & Phòng ngừa</a></li>
              <li><a href="#dental">Nha khoa & Sức khỏe răng miệng</a></li>
              <li><a href="#virtual">Chăm sóc ảo & Từ xa</a></li>
              <li><a href="#rehab">Phục hồi chức năng & Vận động</a></li>
              <li><a href="#women">Sức khỏe phụ nữ</a></li>
              <li><a href="#diagnostics">Chẩn đoán</a></li>
            </ul>
          </div>
          ...
          <div className="footer__links">
            ...
            <ul className="footer__list">
              ...
              <li><a href="#team">Đội ngũ của chúng tôi</a></li>
              <li><a href="#appointments">Đặt lịch hẹn</a></li>
